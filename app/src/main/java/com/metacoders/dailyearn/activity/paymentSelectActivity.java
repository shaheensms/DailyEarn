...
public class paymentSelectActivity extends AppCompatActivity {
    ...
    ImageView pmMoney , netTeller , payPal , payza  , bitcoin ;
    String msg = "" ;
    Button proceedBtn ;
    String Flag = null ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payPal = findViewById(R.id.paypalImage) ;
        payza = findViewById(R.id.payzaImage) ;
        ...
        payza.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                triggerDialogue("Payza");
